            ...
            <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><a href="#about" onClick={() => scrollToSection('about')} className="hover:text-blue-600 transition-colors">About Us</a></li>
                            <li><a href="#services" onClick={() => scrollToSection('services')} className="hover:text-blue-600 transition-colors">Services</a></li>
                            <li><a href="#projects" onClick={() => scrollToSection('projects')} className="hover:text-blue-600 transition-colors">Projects</a></li>
                            <li><a href="#contact" onClick={() => scrollToSection('contact')} className="hover:text-blue-600 transition-colors">Contact</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start">
                                <LocationIcon className="w-5 h-5 mt-1 mr-3 flex-shrink-0 text-blue-600" />
                                <span>123 Digital Avenue, Tech City</span>
                            </li>
                            <li className="flex items-start">
                                <MailIcon className="w-5 h-5 mt-1 mr-3 flex-shrink-0 text-blue-600" />
                                <a href="mailto:contact@nimbusquest.com" className="hover:text-blue-600 transition-colors">contact@nimbusquest.com</a>
                            </li>
                            <li className="flex items-start">
                                <PhoneIcon className="w-5 h-5 mt-1 mr-3 flex-shrink-0 text-blue-600" />
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="#" aria-label="LinkedIn" className="text-slate-500 hover:text-blue-600 transition-colors"><LinkedInIcon /></a>
                            <a href="#" aria-label="Twitter" className="text-slate-500 hover:text-blue-600 transition-colors"><TwitterIcon /></a>
                            <a href="#" aria-label="Facebook" className="text-slate-500 hover:text-blue-600 transition-colors"><FacebookIcon /></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-16 border-t border-slate-200 pt-8 text-center">
                    <p className="text-sm text-slate-500">
                        &copy; {new Date().getFullYear()} Nimbus Quest Pvt. Ltd. All Rights Reserved.
                    </p>
                </div>
            </div>
        </footer>
